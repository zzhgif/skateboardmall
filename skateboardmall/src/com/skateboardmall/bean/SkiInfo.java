...
public class SkiInfo {
	...
	private String ski_picture1;//商品图片
	private String ski_picture2;//商品图片xiao 
	
	public SkiInfo(){}

	public SkiInfo(String ski_id, String ski_name, String ski_type, Double ski_price, String ski_size, String ski_color,
			String ski_des, Integer ski_state, String ski_picture1, String ski_picture2) {
		super();
		this.ski_id = ski_id;
		...
		this.ski_picture1 = ski_picture1;
		this.ski_picture2 = ski_picture2;
	}
	...
	public String getSki_picture1() {
		return ski_picture1;
	}

	public void setSki_picture1(String ski_picture1) {
		this.ski_picture1 = ski_picture1;
	}

	public String getSki_picture2() {
		return ski_picture2;
	}

	public void setSki_picture2(String ski_picture2) {
		this.ski_picture2 = ski_picture2;
	}
	...
	public String toString() {
		return "SkiInfo [ski_id=" + ski_id + ", ski_name=" + ski_name + ", ski_type=" + ski_type + ", ski_price="
				...
				+ ", ski_state=" + ski_state + ", ski_picture1=" + ski_picture1 + ", ski_picture2=" + ski_picture2
				+ "]";
	}
