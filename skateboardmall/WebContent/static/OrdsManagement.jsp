			  ...
			  <table class="table table-striped table-advance table-hover" id="hidden-table-info">
                ...
                <thead>
                  <tr>
                    ...
                    <th><i class=" fa fa-edit"></i> 用户编号</th>
                ...
                <%
                	...
                	pageContext.setAttribute("skiService", skiService);
		                ...
		                <td>${order.getUser_id()} </td>
		               	<c:choose>
		               		...
		               		<c:when test="${order.getOrder_state()==1}">
		               			<td><span class="label label-success label-mini">已确定</span><span class="label label-warning label-mini">未知</span></td>
	          	...
	          	data:{"deptid":aData[1]},
	               ...
	               //	html = $($.parseHTML(result)).find('#Gallery').html();
					...
					$data.each(
						function() {
							//sOut += '<tr >';
							//sOut += '<td>' + this.ords_id + '</td>';
							//sOut += '<td>' + this.order_id + '</td>';
							//sOut += '<td>' + this.ski_id + '</td>';
							//sOut += '<td>' + this.count + '</td>';
							//sOut += '</tr >';
							...
							$tbody.append("<td>" + this.ski_id + "</td>");
